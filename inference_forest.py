...
def parse_arguments():
    ...
    parser.add_argument('-i', '--images', default=r'/data/fpc/inference/5_classes_use/test/river_plant_pg/256/9_forest/img', type=str,
                        help='Path to the images to be segmented')
    parser.add_argument('-o', '--output', default=r'/data/fpc/output/outputs_12_01_forest/', type=str,
                        help='Output Path')
...
def mask2source(image_path, mask, output_path, alpha):
    ...
    pd[np.where(label == 9)] = [255,0,0] # 青色
