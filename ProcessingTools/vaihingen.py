...
def parse_args():
    ...
    parser.add_argument("--img-dir", default="/mnt/data/chenyuxia/EXPERIMENTAL/vaihingen/seed42_512_1581/val/images_")
    parser.add_argument("--mask-dir", default="/mnt/data/chenyuxia/EXPERIMENTAL/vaihingen/seed42_512_1581/val/labels_")
    parser.add_argument("--output-img-dir", default="/mnt/data/chenyuxia/EXPERIMENTAL/vaihingen/seed0_512_1578/val/images")
    parser.add_argument("--output-mask-dir", default="/mnt/data/chenyuxia/EXPERIMENTAL/vaihingen/seed0_512_1578/val/labels")
