...
def parse_args():
    ...
    parser.add_argument("--img-dir", default="/mnt/data/chenyuxia/EXPERIMENTAL/potsdam/ori/val/images_")
    parser.add_argument("--mask-dir", default="/mnt/data/chenyuxia/EXPERIMENTAL/potsdam/ori/val/labels_")
    parser.add_argument("--output-img-dir", default="/mnt/data/chenyuxia/EXPERIMENTAL/potsdam/seed0_512/val/images")
    parser.add_argument("--output-mask-dir", default="/mnt/data/chenyuxia/EXPERIMENTAL/potsdam/seed0_512/val/labels")
    parser.add_argument("--eroded", default=False)
    parser.add_argument("--gt", default=False)  # output RGB mask
...
def image_augment(image, mask, patch_size, mode='train', val_scale=1.0):
    ...
    if mode == 'train':
        ...
        # image_rotate,mask_rotate = image.copy().transpose(Image.ROTATE_180), mask.copy().transpose(Image.ROTATE_180)
