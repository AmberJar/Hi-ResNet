...
save_path = '/data/fpc/data/Mapillaryv1_2/mp_pretrain_dataset/raw/val/images_376/'  # 原图crop后保存路径
save_gt_path = '/data/fpc/data/Mapillaryv1_2/mp_pretrain_dataset/raw/val/labels_376/'  # mask crop后保存路径
