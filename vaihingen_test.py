...
def parse_arguments():
    ...
    parser.add_argument('-m', '--model', default='/mnt/data/chenyuxia/saved/HRNet_Vaihingen/04-12_09-29/best_model.pth',
                        type=str,
                        help='Path to the .pth model checkpoint to be used in the prediction')
    parser.add_argument('-i', '--images', default=r'/mnt/data/chenyuxia/EXPERIMENTAL/vaihingen/seed0_512_1578/val/images', type=str,
...
for i, path in enumerate(tbar):
    ...
    save_label_path = r'/mnt/data/chenyuxia/EXPERIMENTAL/vaihingen/test/label_res/' + path[len(args.images): -len(
         args.extension)] + "png"
    # # # print(save_path)
    ...
    target_path = os.path.join(r'/mnt/data/chenyuxia/EXPERIMENTAL/vaihingen/seed0_512_1578/val/labels', target_id)
