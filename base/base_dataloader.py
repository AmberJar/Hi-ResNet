...
class BaseDataLoader(DataLoader):
    def __init__(self, dataset, batch_size, shuffle, num_workers, val_split=0.0, sampler=None, drop_last=True):
        ...
        super(BaseDataLoader, self).__init__(sampler=sampler, **self.init_kwargs, drop_last=True)
