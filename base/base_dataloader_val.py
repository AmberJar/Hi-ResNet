...
class BaseDataLoaderVal(DataLoader):
    def __init__(self, dataset, batch_size, shuffle, num_workers, val_split=0.0, drop_last=True):
        ...
        super(BaseDataLoaderVal, self).__init__(sampler=self.train_sampler, **self.init_kwargs, drop_last=True)
