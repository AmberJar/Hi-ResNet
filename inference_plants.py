...
def parse_arguments():
    ...
    parser.add_argument('-c', '--config', default='config_hrnet_plants_inference.json', type=str,
                        help='The config used to train the model')
    parser.add_argument('-mo', '--mode', default='multiscale', type=str,
                        help='Mode used for prediction: either [multiscale, sliding]')
    parser.add_argument('-m', '--model', default='/data/fpc/saved/HRNet_PLANTS/01-03_20-30/best_model.pth',
                        type=str,
                        help='Path to the .pth model checkpoint to be used in the prediction')
    parser.add_argument('-i', '--images', default=r'/data/fpc/inference/taian_data/taobao_map/taian', type=str,
                        help='Path to the images to be segmented')
    parser.add_argument('-o', '--output', default=r'/data/fpc/output/outputs_01_12_vege_01/', type=str,
                        help='Output Path')
