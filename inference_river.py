...
def parse_arguments():
    ...
    parser.add_argument('-m', '--model', default='/data/fpc/saved/HRNET_HDLOSS/best_models/adaspace_best_model.pth',
                        type=str,
                        help='Path to the .pth model checkpoint to be used in the prediction')
    parser.add_argument('-i', '--images', default=r'/data/fpc/inference/piggy', type=str,
                        help='Path to the images to be segmented')
    parser.add_argument('-o', '--output', default=r'/data/fpc/output/outputs_12_08_river_01/', type=str,
                        help='Output Path')
...
# num_classes = 11
normalize = transforms.Normalize([0.271927, 0.26648, 0.278027], [0.115175, 0.114012, 0.11727])
num_classes = 2
...
def mask2source(image_path, mask, output_path, alpha):
    ...
    pd[np.where(label == 1)] = [255,0,0] # 青色
