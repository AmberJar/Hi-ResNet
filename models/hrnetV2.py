...
from models.hrnet_spatial_ocr_blockV2 import BNReLU, SpatialOCR_ASP_Module
from models.hrnet_backboneV2 import HRNetBackbone
from itertools import chain
from utils.helpers import set_trainable


class HRNet_W48_ASPOCR_V2(nn.Module):
    def __init__(self, num_classes, backbone, freeze_bn=False, freeze_backbone=False, **_):
        super(HRNet_W48_ASPOCR_V2, self).__init__()
...
if __name__ == '__main__':
    model = HRNet_W48_ASPOCR(num_classes=2, backbone='hrnet48')
