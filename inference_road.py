...
def parse_arguments():
    ...
    # new road with conn /data/fpc/saved/HRNet_Road/12-11_10-51/best_model.pth
    parser.add_argument('-m', '--model', default='/data/fpc/saved/HRNET_HDLOSS/road_second_0.3/best_model.pth',
                        type=str,
                        help='Path to the .pth model checkpoint to be used in the prediction')
    parser.add_argument('-i', '--images', default=r'/data/fpc/inference/songshanhu/raw', type=str,
                        help='Path to the images to be segmented')
    parser.add_argument('-o', '--output', default=r'/data/fpc/output/outputs_03_03_roads/', type=str,
                        help='Output Path')
...
num_classes = 2
# old road
# [0.402568, 0.406539, 0.401525], [0.135746, 0.140629, 0.127753]

# new road
# [0.442722, 0.378454, 0.43694], [0.183933, 0.163688, 0.16578]
...
if __name__ == '__main__':
    ...
    for path in tqdm(files):
        ...
        outs = F.softmax(torch.from_numpy(outs), dim=-1).cpu().numpy()
