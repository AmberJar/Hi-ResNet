...
国星示例：(5类分割类别+1个背景)x3
"""
# AdaSpaceMaps_palette: 黑-白-蓝-棕-红-绿 RGB值

AdaSpaceMaps_palette = [0, 0, 0,
                        200, 0, 0,
                        250, 0, 150,
                        200, 150, 150,
                        250, 150, 150,
...
if __name__ == "__main__":
    # print(len(CityScpates_palette))
    # print(len(COCO_palette))
    # print(len(ADE20K_palette))
    # print(len(AdaSpaceMaps_palette))
    palette = get_voc_palette(16)
    print(palette)
