...
parser.add_argument("--datadir", dest='datadir', default='/data/fpc/data/love_DA/loveDA/')
...
for dataset in tqdm(args.split):
    indir = osp.join(args.datadir, dataset, 'labels_')
